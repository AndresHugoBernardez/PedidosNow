...

{
    if(conectarse())
    {
        ...
        if(seleccionar("","","","SELECT `ID`,`NOMBRE`,`HORA`,`PRECIO`,`ESTADO` FROM `PEDIDOS` ORDER BY ID DESC"))
        {
...
<footer style="position:sticky;bottom:0;background-color:white">
